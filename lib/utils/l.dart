...
class L {
  static const _t = {
    ...
    'go_to_cart': ['Go to Cart', 'الذهاب إلى السلة'],
    ...
    'secure_payment': ['Secure Payment', 'الدفع الآمن'],
    'payment_failed': [
    ...
    'month': ['Month', 'الشهر'],
    'year': ['Year', 'السنة'],
    'invalid_card_number': ['Invalid card number', 'رقم بطاقة غير صحيح'],
    'invalid_month': ['Invalid month', 'شهر غير صحيح'],
